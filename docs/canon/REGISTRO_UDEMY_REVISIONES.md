...
| 3 | 2026-07-28 | **L06** Basic Agents | Agent = POC `coordinador_caso`; caption ausente → `orchestrator.py` | **HECHO_CLASE** · DEJAR QUIETO | [`../auditoria/udemy-L06-basic-agents-2026-07-28.md`](../auditoria/udemy-L06-basic-agents-2026-07-28.md) |
