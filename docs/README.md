...
- **Udemy Agents SDK → producto (tablero L01–L28 + prompt):** [`canon/plan-udemy-agents-sdk-aplicacion.md`](./canon/plan-udemy-agents-sdk-aplicacion.md)
- **Plantilla cierre por lección Udemy:** [`auditoria/PLANTILLA_udemy-leccion.md`](./auditoria/PLANTILLA_udemy-leccion.md)
