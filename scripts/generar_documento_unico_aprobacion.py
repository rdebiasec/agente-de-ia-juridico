...
def main() -> None:
    ...
    w("```mermaid")
    w("flowchart TD")
    w("  userConsulta[Consulta de la abogada] --> coordinator[coordinador_caso]")
    w("  coordinator --> hechos[analista_cronologia_hechos]")
    w("  coordinator --> tipicidad[analista_responsabilidad_tipicidad]")
    w("  coordinator --> ruta906[analista_ruta_procesal]")
    w("  coordinator --> victimas[analista_representacion_victimas]")
    w("  coordinator --> evidencia[analista_evidencia]")
    w("  coordinator --> audiencias[analista_audiencias]")
    w("  coordinator --> redaccion[redactor_documentos_juridicos]")
    w("  coordinator --> seguimiento[analista_seguimiento_procesal]")
