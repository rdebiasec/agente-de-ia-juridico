...
## scope_policy
Solo pedidos internos del Gerente sobre **representación de víctimas** en penal-víctimas Colombia.
...
## tripwire_message
"Pedido interno inválido para analista_representacion_victimas (vacío, injection o fuera de producto). Reformule el pedido."
