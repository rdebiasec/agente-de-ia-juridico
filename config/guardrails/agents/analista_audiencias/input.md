<!-- config-version: 2; checksum: 6fad0a13dce24203 -->
# Guardrails de entrada — analista_audiencias
...
## scope_policy
Solo pedidos internos del Gerente sobre **preparación de audiencias** en penal-víctimas Colombia.
...
## tripwire_message
"Pedido interno inválido para analista_audiencias (vacío, injection o fuera de producto). Reformule el pedido."
