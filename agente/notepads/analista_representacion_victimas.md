---
caso_id: "{{caso_id}}"
agent_id: "analista_representacion_victimas"
agent_label: "Representación de Víctimas"
updated_at: "{{updated_at}}"
eval_or_session: "{{eval_or_session}}"
source_of_truth: "Expediente.bitacora (Postgres)"
mirror: "Drive Lexiatek casos/<id>/notepads/analista_representacion_victimas.md"
---

# Notepad — Representación de Víctimas
