---
caso_id: "{{caso_id}}"
agent_id: "analista_seguimiento_procesal"
agent_label: "Seguimiento Procesal"
updated_at: "{{updated_at}}"
eval_or_session: "{{eval_or_session}}"
source_of_truth: "Expediente.bitacora (Postgres)"
mirror: "Drive Lexiatek casos/<id>/notepads/analista_seguimiento_procesal.md"
---

# Notepad — Seguimiento Procesal
