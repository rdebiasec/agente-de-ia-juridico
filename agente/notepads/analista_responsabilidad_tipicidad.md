---
caso_id: "{{caso_id}}"
agent_id: "analista_responsabilidad_tipicidad"
agent_label: "Tipicidad y Responsabilidad"
updated_at: "{{updated_at}}"
eval_or_session: "{{eval_or_session}}"
source_of_truth: "Expediente.bitacora (Postgres)"
mirror: "Drive Lexiatek casos/<id>/notepads/analista_responsabilidad_tipicidad.md"
---

# Notepad — Tipicidad y Responsabilidad
