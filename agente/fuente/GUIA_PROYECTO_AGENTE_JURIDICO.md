# GUIA_PROYECTO_AGENTE_JURIDICO

Fuente: documentos/original/GUIA_PROYECTO_AGENTE_JURIDICO.pdf
...
Guia del Proyecto:
Agente de IA Juridico

Un asistente que apoya al abogado,
no que lo reemplaza

50 requisitos - 4 fases - 12 tareas en Jira
Generado: 18/06/2026

Supervisión humana. Tus herramientas. Tus reglas.
IA supervisada por humanos para negocios en crecimiento

DBX Solutions aci Ming com w.dbx-solutions.com
...
Este proyecto nace de lo que el abogado pidió en sus propias palabras: un asistente de
inteligencia artificial que lo apoye en su práctica diaria del derecho colombiano. No buscamos
reemplazar al abogado, sino quitarle carga repetitiva para que se concentre en decidir, revisar
y representar a sus clientes.
Escuchamos tres audios de WhatsApp, los convertimos en 50 requisitos concretos y los
organizamos en cuatro fases de trabajo. Cada fase entrega valor visible antes de pasar a la
siguiente. Todo el avance se sigue en Jira (proyecto KAN) para que negocio, abogado y equipo
técnico vean lo mismo.
Regla del proyecto: el abogado siempre revisa y aprueba. La IA propone
borradores; la responsabilidad profesional es del despacho.

2. Propósito del proyecto — en qué estamos y por
qué

Qué queremos lograr

+ Un asistente que conozca el derecho colombiano y el estilo de trabajo del despacho.

+ Menos tiempo en borradores, seguimientos y respuestas repetitivas al cliente.

+ Más tiempo del abogado en análisis, estrategia y decisiones que sí requieren criterio
humano.

+ Un plan acordado por todos: 50 necesidades claras, priorizadas y con criterio de éxito.

+ Entregas por etapas: primero lo más urgente, luego lo especializado.

Para quién es este proyecto

+ El abogado: define qué necesita, prueba el asistente y aprueba cada capacidad.

+ Negocio / dirección: entiende el alcance, plazos y valor de cada fase.

+ Equipo de implementación: construye módulo por módulo según los requisitos y tickets de
Jira.

Qué NO es este proyecto

+ No es un buscador de jurisprudencia aislado: el abogado pidió apoyo integral.

+ No es un reemplazo del abogado: ningún documento sale sin su revisión.

+ No es un producto genérico: se adapta a las áreas y forma de trabajar de este despacho.

Resultado esperado: un asistente que atienda consultas, analice riesgos, redacte borradores, dé

seguimiento a procesos y comunique con clientes — siempre bajo supervisión humana.

3. Por qué lo hacemos ahora
...
+ Ante una consulta nueva, ordenar hechos, ver riesgos y definir estrategia lleva mucho
tiempo.

Qué cambia con el asistente

El asistente prepara borradores, organiza información y propone caminos. El abogado corrige,

decide y firma. Así el despacho gana velocidad sin perder control.
...
4. Seguimiento en Jira — enlaces del proyecto

Todo el trabajo está registrado en Jira (proyecto KAN, etiqueta agente-juridico). Desde aquí
puede ver el estado de cada fase y cada tarea. Los códigos en azul son enlaces clicables en la
versión digital de este PDF.

Enlaces principales

KAN-4 Iniciativa — Agente de IA Jurídico — Asistente integral derecho colombiano
Proyecto principal que agrupa todo el trabajo. Aquí se ve la visión completa y cómo encajan las cuatro fases.

Ver backlog completo (filtro agente-juridico)
...
5. Qué vamos a hacer — por fases

Fase 0 (11 requisitos)

+ Qué: Enseñar al asistente quién es el abogado, qué áreas practica y cómo debe hablar.

+ Por qué: Sin esto, el asistente respondería de forma genérica y no como su despacho.

Fase 1 (15 requisitos)

+ Qué: Primera versión útil: atender consultas, ver riesgos, redactar borradores y escribir a
clientes.

+ Por qué: Es lo que más alivia la carga diaria y permite probar el valor del proyecto pronto.

Fase 2 (10 requisitos)

+ Qué: Seguimiento de procesos, informes al cliente, revisión de correos y apoyo estratégico.
...
Cuánto trabajo hay en cada etapa del proyecto.
...
6. De dónde salió todo

El abogado registró sus necesidades en tres notas de voz. Las transcribimos, las separamos por
tema y de ahí salió el listado de 50 requisitos.

De audios a asistente: el camino del proyecto

Audios Transcripción Extracción Catálogo Roadmap

WhatsApp y segmentación de requisitos (50 REQ) por fases

Cómo pasamos de las notas de voz a un plan claro para construir el asistente.

Audios procesados

AA SS

audio_001_2 2026-06-18 : Perfil y competencias del asistente jurídico; Seguimiento de casos y
026-06-18 comunicación con clie

audio_002_2 2026-06-18 1:29 1 Emisión de conceptos jurídicos por área del derecho
...
7. Qué necesita el abogado — 8 tipos de tarea

Dosis CLG TIENTS a

Perfil y áreas del derecho

Que el asistente conozca la experiencia del

abogado y las áreas del derecho que

Experiencia, — civil, penal, — laboral,

comercial...

Atender y asesorar al Atender clientes con claridad, empatía y 4 Correos, WhatsApp, explicaciones sencillas.
cliente mensajes profesionales.
Analizar y planificar el Entender el caso, ver riesgos y proponer 8 Riesgos, teoría del caso, civil vs. penal.
caso estrategia.
Redactar documentos Preparar contratos, escritos y recursos con 10 Contratos, memoriales, recursos.
buen lenguaje jurídico.
Gestionar procesos Dar seguimiento a procesos y contarle al 5 Radicaciones, estados, informes
...
En qué tipo de tareas el abogado necesita mas apoyo.

DBX Solutions - contact@dbx-soJutions.com

Pagina 7

www.dbx-solutions.com

### Página 08

8. Catálogo de requisitos — vista general

Tenemos 50 requisitos en total: 14 prioritarios para la primera versión, 7 importantes para el
núcleo del asistente y 29 específicos para tareas avanzadas.

Prioridad de los 50 requisitos
...
Cuántos requisitos son prioritarios para la primera versión vs. los que vienen después.
...
Brindar atención permanente a los clientes

Manejar situaciones delicadas con los clientes

Explicar en lenguaje sencillo los escenarios jurídicos
que enfrenta quien acude al ab

Redactar correos corporativos y mensajes
profesionales para los clientes

Identificar riesgos jurídicos que aparezcan durante la
consulta

Convertir los hechos relatados por el cliente en
narrativas ordenadas y convincentes

Diferenciar cuándo un asunto puede verse como civil
o como penal

Construir teorías del caso

Identificar pruebas faltantes en un asunto

Detectar debilidades en escritos y contestaciones
Cuestionar los puntos débiles de la consulta antes de
presentar un escrito

Preparar entrevistas ante la Fiscalía y ante el juez
Redactar contratos complejos y personalizados de
acuerdo al caso

Blindar contratos para proteger los intereses del
Redactar contratos de prestación de servicios,
rendimiento, inversión, alianzas empre

Preparar escritos para jueces, fiscales, comisarías y
entidades administrativas

Elaborar recursos, solicitudes y excepciones

Redactar, proyectar y emitir conceptos jurídicos en
materia civil, comercial, societa

Los conceptos jurídicos deben incluir el nombre del
cliente y la descripción del prob

Indagar sobre las normas vigentes en Colombia y
formular una conclusión que guíe la d

Emitir recomendaciones jurídicas favorables para que
el cliente tome decisiones infor

Redactar memoriales dirigidos a juzgados, Fiscalía o

entidades administrativas para s
...
9. Fase 0 — Fundamentos (perfil y áreas)

Objetivo: Definir el perfil base del agente: experiencia en derecho colombiano, habilidades
estratégicas, redacción técnica y dominio de las áreas del derecho que el abogado practica.

Antes de empezar: Ninguna — esta es la fase inicial.

En pocas palabras: Enseñar al asistente quién es el abogado, qué áreas practica y cómo debe
hablar.
...
10. Fase 1 — MVP (consulta, redacción y
comunicación)

Objetivo: Primera versión funcional del agente: atender consultas, analizar riesgos, redactar
contratos y escritos básicos, y comunicarse con clientes.

Antes de empezar: Completar Fase 0 (perfil y áreas del derecho).

En pocas palabras: Primera versión útil: atender consultas, ver riesgos, redactar borradores y
escribir a clientes.
...
11. Fase 2 — Gestión, seguimiento y estrategia

Objetivo: Seguimiento procesal, informes mensuales a clientes, revisión de correos y rol
estratégico: organizar ideas, estructurar estrategia (no solo jurisprudencia).

Antes de empezar: Completar Fase 1 (MVP operativo).

En pocas palabras: Seguimiento de procesos, informes al cliente, revisión de correos y apoyo
estratégico.
...
15. Criterios de éxito y próximos pasos
...
Información jurídica Verificar con fuentes oficiales; no inventar sentencias.
Datos confidenciales del Acceso restringido; no usar casos reales para entrenar.
cliente

Depender demasiado de la lA Revisión obligatoria del abogado en todo escrito.

Normas desactualizadas Actualizar periódicamente el conocimiento del asistente.

Próximo paso: iniciar la Fase O en Jira (KAN-5) — definir perfil y áreas del derecho — y luego la
Fase 1 (KAN-6) con la primera versión útil del asistente.

KAN-5 Fase 0 en Jira

KAN-6 Fase 1 (MVP) en Jira
Contacto: contact@dbx-solutions.com + www.dbx-solutions.com
...
16. Anexo — requisitos completos con citas
...
iento, inversión, alianzas

conceptos juridi: |, comercial,
...
¢ Jira KAN-4 — iniciativa principal (enlace en sección 4)
* Jira KAN-5...KAN-8 — épicas por fase

* Jira KAN-9...KAN-20 — tareas de implementación

* requisitos_asistente.json — listado estructurado de los 50 requisitos
+ agente/FASE_0...FASE_3 — plan detallado por fase
+ Audios/processed/ — transcripciones y manifiestos
